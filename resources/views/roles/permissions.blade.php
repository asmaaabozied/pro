    ...
    <div class="box-header with-border">
        <div class="col-sm-12">
            ...
            <div class="col-sm-12" style="background: #3c8dbcab;">
                <h4 style="color: #222d32"><b>{{ trans('role.fields.role.assigned_permissions') }}</b></h4>
            </div>
            <div class="col-sm-12">
                <br/>
            </div>
            ...
            <div class="col-sm-9 text-center">
                <div class="table table-responsive">
                    <table class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                <td><h5><b>{{trans('role.fields.permission.name')}}</b></h5></td>
                                <td></td>
                            </tr>
                        </thead>
                        <tbody>
                            @if(array_key_exists(0, $role->permissions->toArray()))
