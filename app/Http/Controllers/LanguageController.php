...
class LanguageController extends CustomizedAppBaseController
{
    ...
    public function store(CreateLanguageRequest $request)
    {
        ...
        Flash::success(trans('language.messages.created'));
    ...
    public function show($id)
    {
        ...
        if (empty($language)) {
            Flash::error(trans('language.messages.not_found'));
    ...
    public function update($id, UpdateLanguageRequest $request)
    {
        ...
        Flash::success(trans('language.messages.updated'));
    ...
    public function destroy($id)
    {
        ...
        $flag = $this->languageRepository->delete($id);

        if($flag){
            Flash::success(trans('language.messages.deleted'));
        }
